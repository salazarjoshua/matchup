...
type IconButtonProps = ComponentPropsWithoutRef<'button'> & { children: ReactNode };
...
const TitleBar = ({ className, actions, ...props }: TitleBarProps) => (
  <div className={cn('h-title-bar border-hairline flex items-center gap-2 border-b px-3', className)} {...props}>
