...
export const LogoLockup = (props: IconProps) => (
  ...
  >
    ...
    {/* <path
      fill="#fc0"
      d="M0 15.744c0-6.545 7.43-10.32 12.717-6.462l40.566 29.61a8 8 0 0 0 9.434 0l40.566-29.61C108.57 5.423 116 9.199 116 15.744V101a8 8 0 0 1-8 8H8a8 8 0 0 1-8-8z"
    />
    <rect width="32" height="32" x="22" y="59" fill="#fff" rx="6.4" />
    <circle cx="46.001" cy="75" r="6.4" fill="#131313" />
    <rect width="32" height="32" x="62" y="59" fill="#fff" rx="6.4" />
    <circle cx="86.001" cy="75" r="6.4" fill="#131313" /> */}
  </svg>
);
