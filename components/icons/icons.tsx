...
export const EyeSlashIcon = (props: IconProps) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <path d="M22.356 13.417a16 16 0 0 1-2.002 2.695L8.762 4.52A10.4 10.4 0 0 1 11.999 4c3.952 0 7.791 2.272 10.357 6.583.52.873.52 1.961 0 2.834" />
  </svg>
);
...
export const ScaleIcon = (props: IconProps) => (
  ...
  >
    <path
      fill="currentColor"
      d="M15.47 15.47a.75.75 0 0 1 1.06 0l3.25 3.25a.75.75 0 0 1 0 1.06l-3.25 3.25a.75.75 0 1 1-1.06-1.06L17.44 20H8.75a.75.75 0 0 1 0-1.5h8.69l-1.97-1.97a.75.75 0 0 1 0-1.06M4.75 4c.199 0 .39.08.53.22l3.25 3.25a.75.75 0 0 1-1.06 1.06L5.5 6.56v8.694a.75.75 0 0 1-1.5 0V6.56L2.03 8.53A.75.75 0 1 1 .97 7.47l3.25-3.25.114-.094A.75.75 0 0 1 4.75 4M19.25 10a.75.75 0 0 1 .75.75v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 .75-.75M17.25 4A2.75 2.75 0 0 1 20 6.75v.5a.75.75 0 0 1-1.5 0v-.5c0-.69-.56-1.25-1.25-1.25h-.5a.75.75 0 0 1 0-1.5zM13.25 4a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1 0-1.5z"
    />
  </svg>
);
...
export const ChevronDownSmallIcon = (props: IconProps) => (
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M10.586 14a2 2 0 0 0 2.828 0l3.293-3.293a1 1 0 0 0-1.414-1.414L12 12.586 8.707 9.293a1 1 0 1 0-1.414 1.414z"
      clipRule="evenodd"
    />
  </svg>
);
